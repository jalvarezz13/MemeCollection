...
namespace MemeCollection
{
    ...
    /// </summary>
    public sealed partial class TiendaCalcetinesPage : Page
    {
        ...
        {
            this.producto1.titulo = "Calcetin";
            this.producto1.ruta = new BitmapImage(new Uri("ms-appx:///Images/Productos/Calcetines/Calcetines1.jpg"));
            this.producto1.ruta_string = "ms-appx:///Images/Productos/Calcetines/Calcetines1.jpg";
            this.producto1.precio = "4.99";

            this.producto2.titulo = "Calcetin A";
            this.producto2.ruta = new BitmapImage(new Uri("ms-appx:///Images/Productos/Calcetines/Calcetines2.jpg"));
            this.producto2.ruta_string = "ms-appx:///Images/Productos/Calcetines/Calcetines2.jpg";
            this.producto2.precio = "8.99";

            this.producto3.titulo = "Calcetin C";
            this.producto3.ruta = new BitmapImage(new Uri("ms-appx:///Images/Productos/Calcetines/Calcetines3.jpg"));
            this.producto3.ruta_string = "ms-appx:///Images/Productos/Calcetines/Calcetines3.jpg";
            this.producto3.precio = "7.99";

            this.producto4.titulo = "Calcetin W";
            this.producto4.ruta = new BitmapImage(new Uri("ms-appx:///Images/Productos/Calcetines/Calcetines4.jpg"));
            this.producto4.ruta_string = "ms-appx:///Images/Productos/Calcetines/Calcetines4.jpg";
            this.producto4.precio = "12.99";

            this.producto5.titulo = "Calcetin Y";
            this.producto5.ruta = new BitmapImage(new Uri("ms-appx:///Images/Productos/Calcetines/Calcetines5.jpg"));
            this.producto5.ruta_string = "ms-appx:///Images/Productos/Calcetines/Calcetines5.jpg";
            this.producto5.precio = "11.99";

            this.producto6.titulo = "Calcetin E";
            this.producto6.ruta = new BitmapImage(new Uri("ms-appx:///Images/Productos/Calcetines/Calcetines6.jpg"));
            this.producto6.ruta_string = "ms-appx:///Images/Productos/Calcetines/Calcetines6.jpg";
            this.producto6.precio = "5.99";
        }
